    ...
    return (
        <div className='w-full h-full flex flex-col items-center gap-y-12'>
            ...
            <div className='text-center font-bold'>
                <h1 className="md:text-6xl sm:text-5xl text-3xl">Maximize Your Impact</h1>
                <h1 className="leading-relaxed md:text-6xl text-3xl sm:text-5xl"><span className="text-orange-500">Business with</span> R<span className="text-red-700">Max</span></h1>
            </div>
